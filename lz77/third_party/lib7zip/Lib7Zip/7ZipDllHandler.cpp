...
#ifdef USE_STATIC_7Z_COMPONENT
    pFunctions->v.GetMethodProperty = (GetMethodPropertyFunc)GetMethodProperty;
    pFunctions->v.GetNumberOfMethods = (GetNumberOfMethodsFunc)GetNumberOfMethods;
    pFunctions->v.GetNumberOfFormats = (GetNumberOfFormatsFunc)GetNumberOfFormats;
    pFunctions->v.GetHandlerProperty = (GetHandlerPropertyFunc)GetHandlerProperty;
    pFunctions->v.GetHandlerProperty2 = (GetHandlerPropertyFunc2)GetHandlerProperty2;
    pFunctions->v.CreateObject = (CreateObjectFunc)CreateObject;
    pFunctions->v.SetLargePageMode = (SetLargePageModeFunc)SetLargePageMode;
#else
